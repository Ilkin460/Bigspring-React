...
import slide1 from '../../../assets/marketing-slide-1.png'
import slide2 from '../../../assets/marketing-slide-2.png'
import slide3 from '../../../assets/marketing-slide-3.png'

function MarketingSection() {
  const [currentSlide, setCurrentSlide] = useState(0)

  const slides = [
    { id: 0, img: slide1, alt: 'Digital Marketing Dashboard' },
    { id: 1, img: slide2, alt: 'Revenue Analytics Dashboard' },
    { id: 2, img: slide3, alt: 'Stacked Bar Chart Analysis' }
  ]
